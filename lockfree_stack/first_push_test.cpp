...
const size_t NUM_PUSHS = 2000000;
...
void thread_routine(thread_info* data)
{
    ...
    size_t stop_val = data->num_iterations_;
...
int main(int argc, char* argv[])
{
    ...
    size_t thread_task = NUM_PUSHS / num_threads;
    for (long i = 0; i < num_threads; i++)
    {
        arr_info[i].num_iterations_ = thread_task;
    ...
    double average_per_instr = sum / ((double)(2 * NUM_PUSHS));
